...
module bed(q=BedHeight){
   	translate([-180, 40, 0]) rotate([90,90,0]) vslot20x60(400, "Aluminum");
   	translate([80, 40, 0]) rotate([90,90,0]) vslot20x60(400, "Aluminum");
   	translate([-80, 40, 0]) rotate([90,90,0]) vslot20x60(400, "Aluminum");
   	translate([180, 40, 0]) rotate([90,90,0]) vslot20x60(400, "Aluminum");
      
    color("red") translate([-220, 0, 30]) cube([440,20,2]) ;
    color("red") translate([-220, -350, 30]) cube([440,20,2]) ;
       
*    rotate([180,0,90]) Angle(length=350);
*    rotate([180,0,90]) Angle(length=350);
}
...
*   Angle(lenght=100, width=35,thickness=3);
}
